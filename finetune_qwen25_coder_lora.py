...
# Configure logging
log_file = "/scratch/user/joshua9/outputs/qwen25_coder_7b_lora/train.log"
...
output_dir = "/scratch/user/joshua9/outputs/qwen25_coder_7b_lora"
...
try:
    ...
    tokenizer.padding_side = "right"  # Avoid SFTTrainer warning
...
sft_config = SFTConfig(
    ...
    eval_steps=10,  # Match logging_steps
    load_best_model_at_end=True,  # Save best model based on validation loss
